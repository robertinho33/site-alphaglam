        ...
        <div class="container-fluid">
          <div class="contact_link-container">
            <a href="" class="contact_link1">
              ...
              <span>
              Alameda Araguaia, 3628 - Tamboré, Barueri - SP
              </span>
            </a>
            <a href="" class="contact_link2">
              <i class="fa fa-phone" aria-hidden="true"></i>
              <span>
                Contato +55 11 99226-1100
              </span>
            </a>
            <a href="" class="contact_link3">
              <i class="fa fa-envelope" aria-hidden="true"></i>
              <span>
                beautyalphaglam@gmail.com
              </span>
            </a>
          </div>
        </div>
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="guard.html"> Profissionais </a>
                </li>
                <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    <h1>
                        Cuidados para seus cabelos <br>
                      <span>
                        Nossa Responsabilidade
                      </span>
                    </h1>
                    <p>
                     Assumimos a responsabilidade de cuidar da sua saúde e bem-estar, com produtos seguros e sustentáveis. Queremos que você confie em nossos cuidados e sinta a diferença, sabendo que cada escolha nossa visa o melhor para você e para o meio ambiente.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn-1"> Leia mais </a>
                      <a href="" class="btn-2">Obtenha um orçamento</a>
                    </div>
                  </div>
                </div>
              </div>
...
Onde o cuidado encontra a perfeição. Inspiramos confiança e estilo, realçando a sua beleza de forma única e personalizada. Cada detalhe do nosso salão é pensado para oferecer uma experiência sofisticada e acolhedora. Aqui, sua beleza é tratada com a excelência e o respeito que você merece.
            </p>
            <div class="btn-box">
              <a href="https://grupoecobelle.com.br">
                Ler mais
              </a>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              <h6>
               Salão patrocinado pela marca Ecobelle
              </h6>
              <p>
               A ecobelle foi fundada pelo empresário, químico e CEO Érico Bitto, que é o dono da Big Beauty Cosméticos, uma das maiores indústrias de cosméticos do Brasil. O projeto da ecobelle surgiu com a ideia de levar acessibilidade e qualidade de vida para as pessoas através de cosméticos, sem o custo dos insumos de comercialização padrão.
              </p>
              <a href="">
                Ler mais
              </a>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
                  Roberto Ferreira, nosso profissional premiado no projeto Tesoura de Ouro e vencedor do renomado Prêmio Pincel de Ouro, traz talento e excelência para cada detalhe dos nossos serviços. Com um olhar artístico e técnicas impecáveis, Roberto é referência no que há de mais sofisticado em beleza.
              </p>
              <a href="">
                Ler mais
              </a>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                A melhor estrutura de esportes de areia de Alphaville

                Inaugurado em 2022 e sob nova direção desde outubro de 2023, o Prainha Alphaville orgulhosamente se destaca como uma das maiores e mais completa arena de esportes na areia de Alphaville e toda a região.
              </p>
              <a href="">
                Ler mais
              </a>
          ...
          <div class="carousel-item active">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  "O atendimento no AlphaGlam Beauty é simplesmente impecável! Desde a recepção até o cuidado com cada detalhe, me senti em um verdadeiro spa para cabelos. Saí renovada e amando o resultado!"
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                 "Fui extremamente bem atendida no AlphaGlam Beauty! A equipe é super atenciosa e percebe claramente o quanto eles se dedicam a cada cliente. Estou encantada com o resultado e já virei cliente fiel!"
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  "Excelente atendimento e ambiente acolhedor! No AlphaGlam Beauty, me senti respeitada e valorizada em cada etapa. Saí do salão completamente satisfeita com o resultado e impressionada com o profissionalismo da equipe."
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="team_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Quero dedicar um momento para expressar minha profunda admiração pela equipe incrível da AlphaGlam Beauty. Cada um de vocês traz uma paixão única e um talento excepcional para o salão. A forma como vocês cuidam dos clientes, escutando suas necessidades e oferecendo conselhos personalizados, é verdadeiramente inspiradora. A dedicação e o profissionalismo que todos demonstram não só elevam a experiência de cada cliente, mas também criam um ambiente acolhedor e amistoso. Estou muito orgulhoso de ter uma equipe tão talentosa e comprometida. Obrigado por fazer do AlphaGlam Beauty um lugar especial!
        </p>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="info_links">
            ...
            <ul>
              <li>
                <a href="https://drive.google.com/file/d/1d7K5Rr99wV_EVkyOS3M0NHU1mla-fp_I/view">
                  Nossas Redes
                </a>
              </li>
             <!--<li>
        ...
        <div class="col-md-3">
          <div class="info_form ">
            <h5>
              Com assinatura você tem descotos e prêmios
            </h5>
            <form action="#">
  ...
  <footer class="container-fluid footer_section">
    <p>
      &copy; <span id="currentYear"></span> Todos os direitos reservados EcoWeb
      <a href="https://https://grupoecobelle.com.br/">grupoecobelle.com.br</a>
    </p>
  </footer>
  <!-- footer section -->
